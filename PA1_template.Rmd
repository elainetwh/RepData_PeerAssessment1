...
```
Mean of the total number of steps taken per day:**`r as.integer(mean_of_day)`**
<br>Median of the total number of steps taken per day:**`r as.integer(median_of_day)`**<br/>
...
```
The maximum number of steps on average across all the days is:**`r max_step`**
...
```
Missing values in dataset:**`r missing_values`**
...
```
Mean for the total number of steps taken per day:**`r as.integer(new_mean)`**
<br>Median for the total number of steps taken per day:**`r as.integer(new_median)`**<br/>
